...
|--------|----|-----------|
|id|identificador del registro |(se elimina)|
...
|Unnamed: 32 |Null| columna vacía que se elimina en la limpieza|
...
- git clone [Proyecto de clasificacion](https://github.com/tu_usuario/proyecto-clasificacion-cancer-mama.git)
